patrick = {
    ...
    "experience": [
        ...
        },
        {
            ...
            "year_from": "11 / 2017",
            "year_to": "04 / 2018",
            "description": "Bachelor Thesis in 'Design of a motorized docking station for tablet computers'",
            "description_details": [
                "Grade: 1.0 according to German academic grading, equivalent to GPA 4.0",
                "Hardware design using SolidWorks CAD (Computer Aided Design)",
                "Electronics PCB design using KiCAD",
                "Arduino MCU coding",
                "Cost optimization for manufacturing",
                "Human ergonomic design",
            ],
        },
    ],
    "skill": [
    ...
    "contact": {
        ...
        "E-Mail (patrick.hermawan@outlook.com)": {"icon": "📫", "link": "mailto:patrick.hermawan@outlook.com"},
        "WhatsApp (+6285158596077)": {"icon": "🟢", "link": "https://wa.me/6285158596077"},
        "Telegram (+6285158596077)": {"icon": "🔵", "link": "https://t.me/+6285158596077"},
    },
    "resume_link": "https://mega.nz/file/s5ETyQCK#_Unq8UbQtEGXmXu4BtRmoykpETQyHH896TVPk1s1eV4",
    "languages": ["Bahasa Indonesia", "English", "German"],
    "birthday": "15.03.1995",
    "birthplace": "Jakarta, Indonesia",
    "personal_data": {
        "interests_hobbies": ["AI", "cars", "electric vehicles", "social media", "tech", "gadgets", "tesla",
                              "technology", "human psychology", "building PCs", "twitter", "surfing the web",
                              "carspotting"],
        ...
        "favorite_llm": "Google Gemini (Bard)",
        "laptop": "Dell XPS 15",
